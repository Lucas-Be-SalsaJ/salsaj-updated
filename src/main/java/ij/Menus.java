...
public class Menus {
	...
	// macrosMenu;
	private static Menu pluginsMenu, importMenu, saveAsMenu, shortcutsMenu, aboutMenu, filtersMenu, toolsMenu,
			utilitiesMenu, macrosMenu, optionsMenu;
	/*
	 * EU_HOU CHANGES END
	 */
	...
	String addMenuBar() {
		...
		// by Oli
		// ce plug ne marche pas !!! addPlugInItem(edit, "Memory","ij.plugin.Memory", 0,
		// true);
		// EU_HOU Bundle
		...
		// addPlugInItem(toolsMenu, "Radio_Spectrum", "ij.plugin.RadioSpectrum_Reader",
		// 0, false);
		// addPlugInItem(toolsMenu, "Optical_Spectrum", "ij.plugin.TextReader", 0,
		// false);
	...
	public static void updateMenus() {
		...
		// EU_HOU CHANGES
		/*
		 * RGBStackItem.setState(false); HSBStackItem.setState(false);
